...
* [Dickreuter's Python Poker Bot](https://github.com/dickreuter/Poker) ⭐ 2,462 | 🐛 34 | 🌐 Python | 📅 2025-06-26 – Bot for Pokerstars & Partypoker, powered by GA & MCMC.
  ![NLHM][nlhm-badge]
...
* [RLCard](https://github.com/datamllab/rlcard) ⭐ 3,543 | 🐛 80 | 🌐 Python | 📅 2024-06-26 - RLCard is a toolkit for Reinforcement Learning (RL) in card games.
...
* [RLCard](https://github.com/datamllab/rlcard) ⭐ 3,543 | 🐛 80 | 🌐 Python | 📅 2024-06-26 - RLCard has CFR, DQN & NFSP agents built-in!
  ![any players][any-player]
  ![Leduc HM][leduchm-badge]
  ![NLHM][nlhm-badge]
  ![Python Language][python-badge]
...
* [RLCard paper](https://github.com/datamllab/rlcard) ⭐ 3,543 | 🐛 80 | 🌐 Python | 📅 2024-06-26 - Zha, Daochen, et al. "RLCard: A Platform for Reinforcement Learning in Card Games." IJCAI. 2020.
...
* [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 503,652 | 🐛 106 | 📅 2026-09-02
