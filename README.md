...
* [RLCard](https://github.com/datamllab/rlcard) ⭐ 3,538 | 🐛 81 | 🌐 Python | 📅 2024-06-26 - RLCard is a toolkit for Reinforcement Learning (RL) in card games.
...
* [RLCard](https://github.com/datamllab/rlcard) ⭐ 3,538 | 🐛 81 | 🌐 Python | 📅 2024-06-26 - RLCard has CFR, DQN & NFSP agents built-in!
  ![any players][any-player]
  ![Leduc HM][leduchm-badge]
  ![NLHM][nlhm-badge]
  ![Python Language][python-badge]
...
* [RLCard paper](https://github.com/datamllab/rlcard) ⭐ 3,538 | 🐛 81 | 🌐 Python | 📅 2024-06-26 - Zha, Daochen, et al. "RLCard: A Platform for Reinforcement Learning in Card Games." IJCAI. 2020.
...
* [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 495,359 | 🐛 99 | 📅 2026-06-30
